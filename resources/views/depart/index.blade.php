                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="px-4 py-2 border">Department ID</th>
                            ...
                            @if (!@empty($department))
                                @foreach ($department as $depart)
                                    <tr>
                                        ...
                                        <td class=" px-4 py-2 w-4/12 border font-semibold">{{ $depart->dept_id }}</td>
                                        <td class=" px-4 py-2 border font-semibold">{{ $depart->dept_name }}</td>
                                        <td class="px-4 py-2 border w-2/12 text-left md:text-center">
                                            <div class="py-2 inline-flex">
                                                <a href="{{ route('depart.show', $depart->id) }}">
                                                    <x-button
                                            ...
                                            <div class="py-2 inline-flex">
                                                <a href="{{ route('depart.edit', $depart->id) }}">
                                                    <x-button
                                            ...
                                            <div class="py-2 inline-flex">
                                                <form action="{{ route('depart.destroy', $depart->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
