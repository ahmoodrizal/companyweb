    ...
    <div class="header-3-1" style="font-family: 'Poppins', sans-serif">
        <header x-data="{ open: false }"
          ...
          <div class="flex items-center justify-between">
            <a href="#">
              <img src="{{ asset('image/sofTech.png') }}"
                alt="" />
            </a>
          ...
          <nav :class="{'flex': open, 'hidden': !open}"
            ...
            <a href="#" class="nav-text text-sm text-white font-medium mx-0 lg:mx-5 my-4 lg:my-0 relative active">Home</a>
            ...
            <div class="flex items-center justify-end w-full lg:hidden mt-3">
              <a href="{{ route('login') }}" class="btn-fill text-sm text-white font-medium py-3 px-8 rounded-full focus:outline-none">
                Sign In
              </a>
            </div>
          ...
          <div class="hidden items-center justify-end lg:flex">
            <a href="{{ route('login') }}" class="btn-fill text-white font-medium text-sm py-3 px-6 rounded-full focus:outline-none">
              Sign In
            </a>
          </div>
        </header>
          ...
          <div class="mx-auto flex pt-16 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
            ...
            <div
              ...
              <p class="caption-text text-base font-light leading-6 tracking-wide mb-12 lg:mb-20">
                Since 2019. We transform bussiness with adaptable <b>Digital Solutions</b> <br class="sm:block hidden" />
       ...
       <section class="h-full w-full px-8 py-20 bg-white">
        ...
        <div class="content-3-1 flex lg:flex-row flex-col items-center" style="font-family: 'Poppins', sans-serif">
            ...
            <div class="w-full lg:w-1/2 text-center justify-center flex lg:mb-0 mb-12">
                <img id="hero"
                    src="{{ asset('image/undraw_personal_finance_tqcd.png') }}"
                    alt="" />
            </div>
            <!-- Right Column -->
